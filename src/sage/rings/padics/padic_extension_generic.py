...
- Julian Rueth (2012-10-28): added univariate factorization
"""

#*****************************************************************************
#       Copyright (C) 2007-2010 David Roe <roed314@gmail.com>
...
#         return ExtensionFactory, (self.base_ring(), self._pre_poly, self.precision_cap(), self.print_mode(), None, self.variable_name())
    ...
    def fraction_field(self, print_mode=None):
        ...
        EXAMPLES::
            ...
            Unramified Extension in a defined by (1 + O(17^6))*x^4 + (O(17^6))*x^3 + (7 + O(17^6))*x^2 + (10 + O(17^6))*x + (3 + O(17^6)) of 17-adic Field with capped relative precision 6
    ...
    def integer_ring(self, print_mode=None):
        ...
        EXAMPLES::
            ...
            sage: U.integer_ring()
            Unramified Extension in a defined by (1 + O(17^6))*x^4 + (O(17^6))*x^3 + (7 + O(17^6))*x^2 + (10 + O(17^6))*x + (3 + O(17^6)) of 17-adic Ring with capped relative precision 6
            sage: U.fraction_field({"pos":False}) == U.fraction_field()
            False
        """
