...
An Eisenstein extension::
    ...
    sage: W.<w> = R.ext(f); W
    Eisenstein Extension in w defined by (1 + O(5^5))*x^5 + (3*5^2 + O(5^5))*x^3 + (2*5 + 4*5^2 + 4*5^3 + 4*5^4 + O(5^5))*x^2 + (5^3 + O(5^5))*x + (4*5 + 4*5^2 + 4*5^3 + 4*5^4 + O(5^5)) of 5-adic Ring of fixed modulus 5^5
    sage: z = (1+w)^5; z
